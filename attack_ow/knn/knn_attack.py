...
def feature_transform():
    filepath = "/media/zyan/文档/毕业设计/code/dataset/round9/tcp_time_direction_len/"
    output_path = "/media/zyan/文档/毕业设计/code/dataset/round9/my_knn_data/"
...
def feature_transform_open_world():
    filepath = "/media/zyan/文档/毕业设计/code/dataset/round10/tcp_time_direction_len/"
    output_path = "/media/zyan/文档/毕业设计/code/dataset/round10/my_knn_data/"
    files = os.listdir(filepath)
    for file in files:
        single_file_list = []
        with open(filepath + file, 'r') as f:
            for line in f.readlines():
                ...
                if lines[1].startswith("+"):
                    ...
                    single_file_list.append(lines[0] + "\t" + "-1\n")
        f.close()
        with open(output_path + file[:-4], 'w') as f:
            for item in single_file_list:
                f.write(item)
        f.close()
...
def feature_extraction():
    filepath = "/media/zyan/文档/毕业设计/code/dataset/round10/my_knn_output/my_knn_data/"
    files = os.listdir(filepath)
    feature_label_list = []
    for file in files:
    ...
    with open('/media/zyan/文档/毕业设计/code/dataset/round10/knn_ow5800.csv', 'w') as f:
...
def load_data():
    filepath = '/media/zyan/文档/毕业设计/code/dataset/round10/knn_ow5800.csv'
